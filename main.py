...
if __name__ == "__main__":
    parser = ASCIIMath2MathML(asciimath_grammar, log=False, inplace=False)
    text = ""
    # text = (
    #     text
    #     + """
    ...
    #         :}"""
    # )
    text = text + """root n x sum_(i=1)^n i^3=(frac (n(n+1)) 2)^2"""
    # text = text + "[(1,2), (2^|: 3 :|, (dstyle int x^{2(x-n)})), (2,4)]"
    # text = text + "[[], []]"
    print(parser.translate(text, pprint=False))
