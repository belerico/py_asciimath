...
#     parser = ASCIIMath2MathML(asciimath_grammar, log=True, inplace=False)
#     text = ""
#     # text = (
#     #     text
#     #     + """
...
if __name__ == "__main__":
    ...
    asciimath2mathml = ASCIIMath2MathML(asciimath_grammar, log=False)
    asciimath = "floor root n f(x) times ((a) / (b)) sum_(i=1)^n i^3=(frac (n(n+1)_2) 2)^2"
    latex = asciimath2tex.translate(asciimath)
    mathml = asciimath2mathml.translate(
        "||: [1,larr rarr 2], [2,int[3(x+1)]dx], [arccos x^1, nabla t] :|",
        displaystyle=True,
        dtd_validation=True,
        dtd="mathml1",
        pprint=False,
